...
TCL_ROOT = libinclude("/Tk")
JPEG_ROOT = "/usr/local/lib"
ZLIB_ROOT = libinclude("/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr")
TIFF_ROOT = None
...
class pil_build_ext(build_ext):
    ...
    def build_extensions(self):
        ...
        #add lib path
        add_directory(library_dirs, "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/lib")
        add_directory(include_dirs, "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/Tk.framework/Versions/8.5/Headers")
        add_directory(include_dirs, "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include")
        #
